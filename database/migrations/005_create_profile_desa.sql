CREATE TABLE IF NOT EXISTS village_profiles (
  ...
  hero_title VARCHAR(240) NOT NULL,
  hero_description TEXT NOT NULL,
  overview_kicker VARCHAR(120) NOT NULL,
  overview_title VARCHAR(240) NOT NULL,
  overview_description TEXT NOT NULL,
  overview_body TEXT NOT NULL,
  history_kicker VARCHAR(120) NOT NULL,
  history_title VARCHAR(240) NOT NULL,
  history_description TEXT NOT NULL,
  geography_kicker VARCHAR(120) NOT NULL,
  geography_title VARCHAR(240) NOT NULL,
  geography_description TEXT NOT NULL,
  vision_label VARCHAR(120) NOT NULL,
  vision_title VARCHAR(260) NOT NULL,
  vision_description TEXT NOT NULL,
  is_active BOOLEAN NOT NULL DEFAULT FALSE,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  INDEX idx_village_profiles_active (is_active)
);

CREATE TABLE IF NOT EXISTS village_profile_facts (
  id CHAR(36) PRIMARY KEY,
  profile_id CHAR(36) NOT NULL,
  section ENUM('hero', 'geography_stat', 'geography_border') NOT NULL,
  label VARCHAR(120) NOT NULL,
  value VARCHAR(180) NOT NULL,
  display_order INT NOT NULL DEFAULT 0,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  INDEX idx_village_profile_facts_profile_section_order (profile_id, section, display_order),
  CONSTRAINT fk_village_profile_facts_profile
    FOREIGN KEY (profile_id) REFERENCES village_profiles(id)
    ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS village_profile_highlights (
  id CHAR(36) PRIMARY KEY,
  profile_id CHAR(36) NOT NULL,
  label VARCHAR(120) NOT NULL,
  ...
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  INDEX idx_village_profile_highlights_profile_order (profile_id, display_order),
  CONSTRAINT fk_village_profile_highlights_profile
    FOREIGN KEY (profile_id) REFERENCES village_profiles(id)
    ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS village_profile_pillars (
  id CHAR(36) PRIMARY KEY,
  profile_id CHAR(36) NOT NULL,
  ...
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  INDEX idx_village_profile_pillars_profile_order (profile_id, display_order),
  CONSTRAINT fk_village_profile_pillars_profile
    FOREIGN KEY (profile_id) REFERENCES village_profiles(id)
    ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS village_profile_timeline_items (
  id CHAR(36) PRIMARY KEY,
  profile_id CHAR(36) NOT NULL,
  ...
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  INDEX idx_village_profile_timeline_profile_order (profile_id, display_order),
  CONSTRAINT fk_village_profile_timeline_profile
    FOREIGN KEY (profile_id) REFERENCES village_profiles(id)
    ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS village_profile_missions (
  id CHAR(36) PRIMARY KEY,
  profile_id CHAR(36) NOT NULL,
  ...
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  INDEX idx_village_profile_missions_profile_order (profile_id, display_order),
  CONSTRAINT fk_village_profile_missions_profile
    FOREIGN KEY (profile_id) REFERENCES village_profiles(id)
    ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS village_profile_officials (
  id CHAR(36) PRIMARY KEY,
  profile_id CHAR(36) NOT NULL,
  ...
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  INDEX idx_village_profile_officials_profile_order (profile_id, display_order),
  CONSTRAINT fk_village_profile_officials_profile
    FOREIGN KEY (profile_id) REFERENCES village_profiles(id)
    ON DELETE CASCADE
);
